export async function sha256Hex(blob: Blob): Promise<string> {
    ...
    // Web Crypto is restricted to secure contexts. Self-hosted deployments are
    // often first opened over a LAN HTTP address, where Chrome exposes
    // `crypto` but not `crypto.subtle`; keep chunked uploads working there.
